                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doctors.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="stars" id="stars" value="{{ old('stars', '') }}" step="0.01" max="5">
                            @if($errors->has('stars'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('stars') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_special" id="is_special" value="1" {{ old('is_special', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="expiration_date" id="expiration_date" value="{{ old('expiration_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="latitude" id="latitude" value="{{ old('latitude', '') }}" step="0.00000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="longitude" id="longitude" value="{{ old('longitude', '') }}" step="0.00000001" required>
