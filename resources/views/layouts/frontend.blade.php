                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('portfolio_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.portfolios.index') }}">
                                            {{ trans('cruds.portfolio.title') }}
                                        </a>
                                    @endcan
                                    @can('pharmacy_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.pharmacies.index') }}">
                                    ...
                                    @endcan
                                    @can('day_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.days.index') }}">
                                            {{ trans('cruds.day.title') }}
                                        </a>
                                    @endcan
                                    @can('specialty_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.specialties.index') }}">
                                    ...
                                    @can('appointments_status_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.appointments-statuses.index') }}">
